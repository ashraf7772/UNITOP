...
//The first line checks if there is a parameter named 'search' in the URL 
//query string ($_GET). If the search paramter is present, its value
// is assigned to the variable $search. If the search parameter isn't 
//present $search is assigned an empty String.
//
//The second line checks if there is a parameter named status in the URL
// query string ($_GET). If status is present in the URL query, its 
//value is assigned to the variable $status. If status parameter isnt 
//present, then $status is assigned 'all' as a string  
